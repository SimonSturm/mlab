function [tu,tg] = wendepkt(T,Ks,startval,plot_on)
    ...
    if plot_on == 1
        ...
        plot(t,sys_wndtg,'b','LineWidth',1.5)

        % tu tg ks plotten
        line([min(t) max(t)],[Ks Ks],'Color','g','LineStyle','--','LineWidth',1)
...
%         line([tu tu+tg],[sys_min-Ks*0.025 sys_min-Ks*0.025],'LineWidth',1.5,'Color','r')
        ...
        line([tg+tu tg+tu],[ax_min ax_max],'Color','r','LineStyle','--')
        line([tu tu],[ax_min ax_max],'Color','m','LineStyle','--')
